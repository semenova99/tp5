...
Artemiy Semenov
2025-01-24
Dessin en Arcade d'une vue sur la mer en la ville de Yalta
"""
...
def draw_moon():
    """
    Dessine une lune dans le coin en supérieur droit.
    """
...
def draw_bird(x, y, color):
    """
    Dessine une oiseau dans les coordonnées spécifies en la couleur spécifiée.
    L'oiseau est comme un triangle mais concave sur la base.
    """
